...
def criar_pallet():
    ...
    try:
        ...
        cabecalho = CabecalhoPalletModel(
            ...
            n_imprimir=registro_pallet.cabecalho.n_imprimir
        )
        
        itens = []
        for item_data in registro_pallet.itens:
            item = ItemPalletModel(
                produtor=item_data.produtor,
                tex_produtor=item_data.tex_produtor,
        ...
        response_data = {
            ...
            "n_imprimir": resultado.n_imprimir
        }
            ...
            itens_list = [
                {
                    ...
                    "tex_produtor": item.tex_produtor,
