...
class GvsSystem:
        ...
        if not self.driver:
            ...
            if self.server:
                ...
                preferencias_do_chrome = {
                    'printing.print_preview_sticky_settings.appState': json.dumps({
                        #"recentDestinations": [{"id": "ZEBRA 2", "origin": "local"}],
                        "recentDestinations": [{"id": "ZEBRRA 02", "origin": "local"}],
                        "selectedDestinationId": "ZEBRRA 02",
                        "version": 2,
                        "scalingType": 3,
                        "scaling": "100",
                        "copies": 2,
    ...
    def realizar_login(self):
            ...
            self.driver.find_element(By.XPATH ,'/html/body/div[2]/div[1]/div/div[2]/form/button').click()
...
class RegistroPalletManager(GvsSystem):
    ...
    def realizar_lancamento_pallet(self, registro: RegistroPallet, imprimir_etiqueta=True):
        ...
        print(pallet_id)
        print(self.n_imprimir)
        if self.n_imprimir == 0:
            pass
        else:    
    ...
    def cabecalho_pallet(self):
        ...
        print(cab.n_imprimir)
        print(cab.reprocesso)
    ...
    def montagem_pallet(self, item: ItemPallet):
        ...
        if item.cor == "Vermelha":
            cor_input.send_keys(Keys.ARROW_DOWN)
